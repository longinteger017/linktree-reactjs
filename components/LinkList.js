      ...
      <ul className="w-full md:w-4/5 lg:w-3/6 mx-auto">
        {links.map(link => (
          <li className="mb-4" key={link.title}>
            <a
              className="relative transition duration-200 font-bold bg-blue-500 border-blue-500 border-2 hover:bg-blue-700 py-4 w-100 block text-center text-white-800 hover:text-white-400 rounded-lg pl-12 md:px-12"
              href={link.url}
              target="_blank"
            >
